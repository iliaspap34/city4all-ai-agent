...
function displayResults(features) {
  ...
  features.forEach((feature, index) => {
    ...
    const accessibility = escapeHTML(
  ...
  features.forEach(feature => {
    ...
    const popupTemplate = {
      ...
      content: `
        ...
        <strong>Προσβασιμότητα:</strong>
        ${escapeHTML(feature.accessibility || "")}
      `
    };
